...
const translations = {
  en: {
    ...
    startReadingBookmarks: "Start reading books and bookmark your favorite pages!",
    page: "Page",
    note: "Note",
    remove: "Remove",
    ...
    startReadingHistory: "Start reading to see your history!",
    today: "Today",
    yesterday: "Yesterday",
  ...
  ja: {
    ...
    startReadingBookmarks: "書籍を読み始めて、お気に入りのページをブックマークしてください！",
    page: "ページ",
    note: "メモ",
    remove: "削除",
    ...
    startReadingHistory: "読み始めて履歴を確認してください！",
    today: "今日",
    yesterday: "昨日",
    unknownAuthor: "不明な著者",
